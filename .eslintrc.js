module.exports = {
    ...
    rules: {
        ...
        "no-unneeded-ternary": 0, // 2,//禁止不必要的嵌套 var isYes = answer === 1 ? true : false
        ...
        "newline-after-var": 0, // 2,//变量声明后是否需要空一行
        ...
        "space-return-throw-case": 0, // 2,//return throw case后面要不要加空格
        "space-unary-ops": [
            0,
            {
                words: true,
